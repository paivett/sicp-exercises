...
(define p1terms
  (adjoin-term (make-term 3 4) (adjoin-term (make-term 1 2) (the-empty-termlist))))
(define p1 (make-polynomial 'x p1terms))

(define p2terms
  (adjoin-term (make-term 1 0) (adjoin-term (make-term 0 0) (the-empty-termlist))))
(define p2 (make-polynomial 'x p2terms))

(define p3 (make-polynomial 'x (the-empty-termlist)))
